const styles = {
  ...
  suspended: "border-orange-400/30 bg-orange-500/10 text-orange-300",
  ...
  busy: "border-yellow-400/30 bg-yellow-500/10 text-yellow-300",
  online: "border-emerald-400/30 bg-emerald-500/10 text-emerald-300",
  offline: "border-slate-400/30 bg-slate-500/10 text-slate-300",
